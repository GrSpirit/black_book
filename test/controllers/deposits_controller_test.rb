...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { amount: @deposit.amount, bank: @deposit.bank, date_end: @deposit.date_end, date_start: @deposit.date_start, percent: @deposit.percent } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { amount: @deposit.amount, bank: @deposit.bank, date_end: @deposit.date_end, date_start: @deposit.date_start, percent: @deposit.percent } }
